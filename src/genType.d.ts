...
export interface RuleOptions {
  ...
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/destructuring-properties.md
   */
  'sort/destructuring-properties'?: Linter.RuleEntry<SortDestructuringProperties>
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/export-members.md
   */
  'sort/export-members'?: Linter.RuleEntry<SortExportMembers>
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/exports.md
   */
  'sort/exports'?: Linter.RuleEntry<SortExports>
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/import-members.md
   */
  'sort/import-members'?: Linter.RuleEntry<SortImportMembers>
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/imports.md
   */
  'sort/imports'?: Linter.RuleEntry<SortImports>
  /**
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/object-properties.md
   */
  'sort/object-properties'?: Linter.RuleEntry<SortObjectProperties>
  /**
   * Sorts TypeScript string enums alphabetically and case insensitive in ascending order.
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/string-enums.md
   */
  'sort/string-enums'?: Linter.RuleEntry<SortStringEnums>
  /**
   * Sorts TypeScript string unions alphabetically and case insensitive in ascending order.
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/string-unions.md
   */
  'sort/string-unions'?: Linter.RuleEntry<SortStringUnions>
  /**
   * Sorts TypeScript type properties alphabetically and case insensitive in ascending order.
   * @see https://github.com/mskelton/eslint-plugin-sort/blob/main/docs/rules/type-properties.md
   */
  'sort/type-properties'?: Linter.RuleEntry<SortTypeProperties>
  /**
   * Enforce consistent spacing before blocks
...
type SortDestructuringProperties = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/export-members -----
type SortExportMembers = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/exports -----
type SortExports = []|[{
  groups?: {
    type?: ("default" | "sourceless" | "dependency" | "type" | "other")
    regex?: string
    order: number
  }[]
  typeOrder?: ("preserve" | "first" | "last")
  caseSensitive?: boolean
  natural?: boolean
  [k: string]: unknown | undefined
}]
// ----- sort/import-members -----
type SortImportMembers = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/imports -----
type SortImports = []|[{
  groups?: {
    type?: ("side-effect" | "dependency" | "type" | "other")
    regex?: string
    order: number
  }[]
  separator?: string
...
type SortObjectProperties = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/string-enums -----
type SortStringEnums = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/string-unions -----
type SortStringUnions = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- sort/type-properties -----
type SortTypeProperties = []|[{
  caseSensitive?: boolean
  natural?: boolean
}]
// ----- space-before-blocks -----
